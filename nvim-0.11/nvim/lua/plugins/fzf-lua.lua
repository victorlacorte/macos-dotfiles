return {
  ...
  opts = {
    ...
    grep = {
      ...
      rg_opts = "--column --line-number --no-heading --color=always --smart-case --max-columns=4096 -g '!.git/' -g '!node_modules/' -g '!package-lock.json' -g '!pnpm-lock.yaml' -g '!yarn.lock' -e",
    },
    keymap = {
      fzf = {
